...
export function Footer() {
  return (
    <footer className="bg-gray-900 text-white">
      ...
      {/* Social Media Prominent Section */}
      <div className="border-t border-gray-800 py-12 bg-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8">
            <h3 className="text-2xl font-bold text-white mb-4">Connect With Us</h3>
            <p className="text-gray-300 text-lg">
              Follow our journey and stay updated with the latest luxury real estate developments
            </p>
          </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="flex flex-col md:flex-row items-center gap-2 md:gap-4">
              ...
              <p className="text-gray-500 text-xs">
                DESIGN UPGRADE: <span className="text-white">Niuxverse solutions +2348133979105/+2348110607341</span>, <span className="text-white">BenChuksGlobalLimited (Source Credit)</span>
              </p>
            </div>
